...
- [ ] 2. Mock data layer
  ...
  - [ ] 2.2 Implement the session store
  ...
  - [ ]\* 2.5 Write property test for delay bounds
    - **Property 3: Delayed responses are bounded**
    - **Validates: Requirements 7.5**

  - [ ] 2.6 Implement file selection validation
...
- [ ] 3. API client layer (swap boundary)
  ...
  - [ ] 3.5 Create the public API surface
  ...
  - [ ]\* 3.6 Write unit tests for the client surface
  ...
  - [ ] 3.7 Enforce the swap boundary with ESLint
...
- [ ] 5. Theme system, shared components, and interaction hook
  - [ ] 5.1 Configure the theme and fonts
  ...
  - [ ] 5.2 Implement shared state components and the lifecycle hook
  ...
  - [ ]\* 5.3 Write unit tests for shared components and hook
...
- [ ] 6. Landing page
  - [ ] 6.1 Root layout, site config, and metadata
  ...
  - [ ] 6.2 Build the landing sections
  ...
  - [ ]\* 6.3 Write unit tests for landing content constraints
...
- [ ] 7. Dashboard shell and core pages
  - [ ] 7.1 Build the dashboard shell and route boundaries
  ...
  - [ ] 7.3 Implement the recall/diagnosis page
  ...
  - [ ]\* 7.4 Write property test for DiagnosisCard
    - **Property 5: DiagnosisCard renders the full recommendation**
    - **Validates: Requirements 9.3**

  - [ ] 7.5 Implement the memory graph page
  ...
  - [ ] 7.6 Implement the release/drift page
  ...
  - [ ]\* 7.7 Write property test for the drift panel
    - **Property 6: DriftIndicator always shows state and reason**
    - **Validates: Requirements 9.5**

  - [ ] 7.8 Implement the forget/demo-reset page
...
- [ ] 8. Integration and wiring
  - [ ] 8.1 Wire navigation and enforce visual consistency
  ...
  - [ ]\* 8.2 Write integration test for the demo loop
