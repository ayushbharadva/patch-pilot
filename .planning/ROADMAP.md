...
- [x] 04-01-PLAN.md — Corpus enrichment (D-09) + fresh post-enrichment snapshot (B-03) — the data foundation for reset + graph [wave 1]
...
- [x] 04-03-PLAN.md — Memory graph: GET /graph (real Cognee export) + 3D ForceGraph tab + click-to-explore (GRAPH-01, STRETCH-04) [wave 3]

**Wave 4** *(GATE — blocked on Waves 2–3)*

- [x] 04-04-PLAN.md — 120-second loop timing verification; gates all stretch work (DEMO-03) [wave 4]
...
| 4. Demo Loop + Stretch | 4/6 | In Progress|  |
